  ...
  const projects = [
    {
      title: "PolyRAG",
      description:
        "A Multilingual Retrieval-Augmented Generation System for Context-Aware Question Answering from Global PDFs",
    ...
    },
    {
      title: "SynapseOps",
      description:
        "Automated data analysis for support, driving clear, actionable process improvement.",
    ...
    {
      title: "SocialFlow",
      description: "Content scheduling powered by AI!",
      tags: ["Next.js", "Postgres", "Redis", "+3"],
      stars: null,
          ...
          {projects.map((project, index) => (
            ...
            >
              <CardHeader className="pb-2 pt-4 px-4 grow">
                ...
                <Link href="" onClick={() => window.open(project.url, "_blank", "noopener,noreferrer")}>
                  <IoLogoGithub />
                 </Link>
                  <CardTitle className="font-soria text-base font-normal">
                    {project.title}
                  </CardTitle>
                  {project.stars && (
